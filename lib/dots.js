  ...
  render: function render() {
    ...
    if (this.props.newDots) {
      ...
      dots = _react2.default.createElement(
        'span',
        { className: className },
        _react2.default.cloneElement(this.props.customPaging(this.props.currentSlide), { onClick: onClick })
      );
    } else {
      // Apply join & split to Array to pre-fill it for IE8
      //
      // Credit: http://stackoverflow.com/a/13735425/1849458
      dots = Array.apply(null, Array(dotCount + 1).join('0').split('')).map(function (x, i) {
